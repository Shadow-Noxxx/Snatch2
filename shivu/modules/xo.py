"""
Tic-Tac-Toe (XO) Telegram Bot Module.

Provides commands and handlers for playing Tic-Tac-Toe in Telegram chats.
Exports:
    - setup_handlers(application): Registers all handlers for this module.
"""
...
def setup_handlers(application):
    """
    Registers all command and callback handlers for the XO module.
    """
